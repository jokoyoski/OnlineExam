...
let AuthService = class AuthService {
    ...
    Submit(question) {
        const tokenId = localStorage.getItem('userId');
        return this.http.post('http://localhost:5000/api/question/' + tokenId + '/submitTest', question).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
            this.result = response;
