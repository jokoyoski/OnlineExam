...
let CategoryResolver = class CategoryResolver {
    ...
    resolve(route) {
        return this.questionService.getCategories().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(error => {
            this.router.navigate(['/members']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    }
};
CategoryResolver.ctorParameters = () => [
