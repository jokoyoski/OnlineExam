...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.Submit = function (question) {
        var _this = this;
        var tokenId = localStorage.getItem('userId');
        return this.http.post(this.prodUrl + 'question/' + tokenId + '/submitTest', question).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            _this.result = response;
